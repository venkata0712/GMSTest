...
public class ManagePurchasesLocators {
	...
	@FindBy(xpath = "//a/strong[text()='Manage Purchase']")
	...
	@FindBy(xpath = "//span[@class = 'select2-search select2-search--dropdown']/input[@type='search' and @class='select2-search__field']")
	...
	@FindBy(xpath = "//*[@id='mainBody']/div[32]/div[2]/div/div/div/div/div/div/div/div[4]/button[1]")
	...
	@FindBy(xpath = "//div[@id='displayVehicleInput']//div[@class='col-md-2 manageSelect2']//span[@role='combobox']")
