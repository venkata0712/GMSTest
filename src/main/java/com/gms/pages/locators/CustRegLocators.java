...
public class CustRegLocators {
	...
	@FindBy(id = "closeregisterVehicle")
	...
	@FindBy(id = "hideMessage")
	public WebElement sucessmsg1;
	@FindBy(xpath = "//button[text() = 'Estimation']")
	public WebElement gotoEstBtn1;
	@FindBy(id = "closeButtonImages")
	public WebElement closePopEstBtn1;
	
	
//	@FindBy(xpath = "//*[@id = 'select2-vehicleType-container']/span")
//	public WebElement vehNameConta;
	@FindBy(xpath = "//*[@id = 'select2-vehicleType-container']")
	public WebElement vehNameConta;
	@FindBy(xpath = "//*[@id = 'select2-reg_nbr_plate_color-container']")
	public WebElement nbrPlateColConta;
	@FindBy(xpath = "//*[@id = 'select2-customerSourceMain-container']")
	public WebElement custSourceConta;
